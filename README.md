...
- Вариант 1. [jq](https://github.com/jqlang/jq) - утилита для работы с JSON.
- Вариант 2. [xmlstarlet](https://sourceforge.net/p/xmlstar/code/ci/master/tree/) - утилита для работы с XML.
